    ...
    <section class="sidebar">
      ...
      <!--   <li class="active"><a href="#"><i class="fa fa-link"></i> <span>Link</span></a></li>
        ...
        <!-- </li>
         ...
         <li class="treeview">
          <a href="#"><i class="fa fa-user-o"></i> <span>Thống Kê Nhân viên</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="admin/user/danhsach_nv"><i class="fa fa-reorder"></i>Danh Sách Nhân Viên</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="admin/bill/xacnhan"><i class="fa fa-reorder"></i>DS Đơn Hàng Đã Xác Nhận</a></li>
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-cubes"></i> <span>Lịch sử</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="admin/lichsu/actionbill"><i class="fa fa-reorder"></i>Lịch sử HĐ đơn hàng </a></li>
            <li><a href="admin/lichsu/action_products"><i class="fa fa-reorder"></i>Lịch sử HĐ sản phẩm </a></li>
