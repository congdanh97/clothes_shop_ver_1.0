	...
	<div class="container">
		<div id="content">
			<form action="{{route('dathang')}}" method="post" class="beta-form-checkout">
				...
				@if(Session::has('thongbao_sanphamhet'))
				<div class="alert alert-danger">
					<h2>Sản phẩm {{Session::get('thongbao_sanphamhet')}} không đủ số lượng bạn yêu cầu! <h2>
				</div>
				@endif
				</div>
				<div class="row">
							...
							<div class="input-checkbox">
								...
								<div class="caption">
									<p>Chuyển tiền đến số tài khoản sau:
										<br>-Số tài khoản: 9704 0507 64194580
										<br>-Chủ TK: NGUYỄN CÔNG DANH
										<br>-Ngân Hàng AgriBank, chi nhánh Hà Nội.
										<p>
								</div>
							</div>
						</div>
