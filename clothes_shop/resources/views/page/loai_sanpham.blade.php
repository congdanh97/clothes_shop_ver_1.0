	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li class="active">Loại sản phẩm : {{$loai_sp->name}}</li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
							...
							<div class="col-md-4 col-sm-6 col-xs-6" style="height: 500px;">
								<div class="product product-single">
									<div class="product-thumb">
										...
										<button class="main-btn quick-view"><a href="{{route('chitietsanpham',$sp->id)}}"><i class="fa fa-search-plus"></i> view detail</a></button>
									...
									<div class="product-body">
										...
										<h2 class="product-name" style="font-size: 14px;"><a href="{{route('chitietsanpham',$sp->id)}}">{{$sp->name}}</a></h2>
										<div class="product-btns">
											<button class="main-btn icon-btn"><i class="fa fa-heart"></i></button>
											<button class="main-btn icon-btn"><i class="fa fa-exchange"></i></button>
											<a href="{{route('themgiohang',$sp->id)}}"><button class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> Thêm vào giỏ hàng</button></a>
										</div>
									</div>
								</div>
							</div>
