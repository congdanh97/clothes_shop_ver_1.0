...
<!-- BREADCRUMB -->
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				<li><a href="http://localhost/clothes_shop/public/index">Home</a></li>
				<li class="active"><a href="http://localhost/clothes_shop/public/dang-ky">ĐĂNG KÝ TÀI KHOẢN</a></li>
			</ul>
		</div>
	</div>
	<!-- /BREADCRUMB -->
    ...
    margin: auto; height: 500px; margin-top: 20px;">
					...
					@endif
							...
							<div class="form-group">
								<button type="submit" class="btn btn-primary btn-block">ĐĂNG KÍ <i class="icon-circle-right2 position-right"></i></button>
							</div>
