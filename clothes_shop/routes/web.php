...
Route::post('add-to-cart/{id}',[
	'as'=>'themgiohang12',
	'uses'=>'PageController@getAddtoCart12'
]);
...
Route::post('add-comment',[
	'as'=>'add_comment',
	'uses'=>'CommentController@postAdd'
])->middleware('auth');
...
Route::group(['prefix'=>'admin','middleware'=>'admin'],function(){
	...
	Route::group(['prefix'=>'danhmuc'],function(){
		...
		Route::get('danhsach_nv','UserController@getDanhSach_nv');
	});
	...
	Route::group(['prefix'=>'bill'],function(){
		...
		Route::get('xacnhan','BillController@getXacNhan');
		Route::post('xacnhan/{id}','BillController@postXacNhan');
	...
	Route::group(['prefix'=>'lichsu'],function(){
		//admin/bill/
		Route::get('actionbill','LichSuController@getListActionOnBills');
		Route::get('chitietdon/{id}','LichSuController@getChitiet');
		Route::get('ban','LichSuController@getBan');
		Route::get('action_products','LichSuController@getListActionProducts');

		
		//Route::post('ban/{id}','LichSuController@postBan');

		Route::get('huy','LichSuController@getHuy');
		Route::post('huy/{id}','LichSuController@postHuy');
	});
